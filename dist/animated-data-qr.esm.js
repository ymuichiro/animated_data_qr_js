...
async function createTransferFrames(fileLike, options = {}) {
  ...
  const sessionId = (_e = options.sessionId) != null ? _e : createSessionId();
...
var AnimatedQrSender = class extends SimpleEmitter {
  constructor(options = {}) {
    ...
    this.symbolsPerFrame = (_e = options.symbolsPerFrame) != null ? _e : DEFAULT_SYMBOLS_PER_FRAME;
  ...
  async prepare(fileLike, options = {}) {
    ...
    const transfer = await createTransferFrames(fileLike, {
      ...
      frameIntervalMs: (_e = options.frameIntervalMs) != null ? _e : this.frameIntervalMs
    });
...
var AnimatedQrReceiver = class extends SimpleEmitter {
  ...
  async start(constraints = void 0) {
    ...
    if (!this.stream) {
      await this.startCamera(constraints != null ? constraints : this.cameraConstraints);
    }
    if (this.scanning) {
      return;
    }
...
getCandidateSymbolCounts_fn = function() {
  const counts = /* @__PURE__ */ new Set([1]);
...
readFrameInputs_fn = async function() {
  ...
  return __privateMethod(this, _AnimatedQrReceiver_instances, dedupeFrameInputs_fn).call(this, inputs);
};
export {
  AnimatedQrReceiver,
  AnimatedQrSender,
